...
- `res` is an object of class `"mdm"` containing:
  ...
  - Currently the availiable methods are "hc" Hill-climbing structure learning using the `bnlearn` package and "ipa": Integer Programming Approach using GOBNILP with Jaakkola scoring.
